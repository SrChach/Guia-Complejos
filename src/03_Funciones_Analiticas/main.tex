...
\input{src/formulas/01_De_Moivre/main}

\subsection{Raíces enésimas}
\input{src/formulas/02_nth_roots/explained}
...
\input{src/teoremas/01_Cauchy-Riemann/main}
...
\input{src/teoremas/02_Funciones_Analiticas/main}
